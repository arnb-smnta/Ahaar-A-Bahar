...
export const postgres_url = process.env.PGHOST;
export const postgres_DB_name = process.env.PGDATABASE;
export const postgres_user = process.env.PGUSER;
export const postgres_password = process.env.PGPASSWORD;
export const postgres_endpoint_id = process.env.ENDPOINT_ID;
